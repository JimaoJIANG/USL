...
These files contain the model predictions that can be further analyzed to assess performance.

### Evaluation
For a comprehensive evaluation, use the provided MATLAB script located at `./MATLAB/evaluation/evaluation.m`. 
This script performs atlas-based segmentation and additional quantitative analyses.
