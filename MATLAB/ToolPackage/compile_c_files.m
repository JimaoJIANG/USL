...
cd('/home/vision/diskB/home/vision/zyg/matlab/Voltool/ToolPackage/functions_nonrigid/');
files=dir('*.c');
...
cd('/home/vision/diskB/home/vision/zyg/matlab/Voltool/ToolPackage/functions_affine/');
files=dir('*.c');
for i=1:length(files)
    filename=[files(i).name];
    if(length(filename)<19||(~strcmpi(filename(1:19),'image_interpolation')))
