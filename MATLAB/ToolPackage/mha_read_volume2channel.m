function V = mha_read_volume2channel(info)
...
fclose(fid);
%a0=info.Dimensions(1);
a1=info.Dimensions(1);
a2=info.Dimensions(2);
a3=info.Dimensions(3);
V = reshape(V,[ 2, a1, a2, a3]);
%V = reshape(V,[3, info.Dimensions]);
